...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, ICM_CS_Pin|OLED_SDA_Pin|OLED_SCL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PC13 ICM_CS_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_13|ICM_CS_Pin;
  ...
  GPIO_InitStruct.Pin = TOF_DRDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(TOF_DRDY_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : PB13 KEY2_Pin KEY1_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_13|KEY2_Pin|KEY1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
